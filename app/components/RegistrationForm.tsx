				...
				<Card className="w-full max-w-4xl mx-auto">
					<CardHeader>
						...
						{/* <div className="flex items-center space-x-2">
							<Switch id="theme-mode" checked={theme === 'dark'} onCheckedChange={() => setTheme(theme === 'dark' ? 'light' : 'dark')} />
						...
						<form onSubmit={form.handleSubmit(onSubmit)}>
							<Tabs defaultValue="personal" className="w-full">
								...
								<TabsContent value="fields">
									<FieldsTab fields={fields} form={form} append={append} remove={remove} />
								</TabsContent>
							</Tabs>
							<div className="mt-6">
								<h3 className="text-lg font-semibold mb-2">Document Uploads</h3>
								<div className="grid grid-cols-2 gap-4">
									<FileUpload label="Profile Picture" name="profilePic" accept="image/*" onChange={handleFileChange} />
									<FileUpload label="Aadhar Document" name="aadhar" accept="application/pdf" onChange={handleFileChange} />
									<FileUpload label="Land Document" name="land" accept="application/pdf" onChange={handleFileChange} />
									<FileUpload label="Bank Document" name="bank" accept="application/pdf" onChange={handleFileChange} />
								</div>
							</div>
			...
			<Dialog open={open} onOpenChange={setOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>Are you sure you want to submit this farmer registration form?</DialogDescription>
					</DialogHeader>
					<DialogFooter>
